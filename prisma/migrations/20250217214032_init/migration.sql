...
-- AddForeignKey
ALTER TABLE "HomeClass" ADD CONSTRAINT "HomeClass_homeroomFacultyMemberId_fkey" FOREIGN KEY ("homeroomFacultyMemberId") REFERENCES "FacultyMember"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Event" ADD CONSTRAINT "Event_timeSlotId_fkey" FOREIGN KEY ("timeSlotId") REFERENCES "TimeSlot"("id") ON DELETE SET NULL ON UPDATE CASCADE;
