...
export function getDateRangeFromTimeSlot(timeSlot: TimeSlot, year: number, weekNumber: number): { startDate: Date, endDate: Date } {
    ...
    startDate.setUTCDate(firstMonday.getUTCDate() + (weekNumber - 1) * 7 + timeSlot.dayOfWeek);
